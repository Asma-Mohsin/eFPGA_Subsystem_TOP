...
$(PDK_ROOT)/$(PDK):
	...
	git clone $(PDK_REPO_IHP_OPEN_PDK) --recurse-submodules --depth=1000  $(PDK_ROOT)
	git -C $(PDK_ROOT) fetch origin $(PDK_COMMIT_IHP_OPEN_PDK)
	git -C $(PDK_ROOT) checkout $(PDK_COMMIT_IHP_OPEN_PDK)
